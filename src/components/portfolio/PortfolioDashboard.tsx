...
export function PortfolioDashboard() {
  const { assets, summary, currency, isLoading, isRefreshing, setCurrency, addAsset, editAsset, removeAsset } =
    usePortfolio();
  ...
  return (
    <div className="flex flex-col min-h-[calc(100vh-4rem)] p-4 md:p-8 space-y-6">
      <div className="flex flex-col space-y-2 pb-6">
        ...
        <p className="text-muted-foreground">Manage your assets and view your portfolio performance.</p>
      </div>
      ...
      <div className="space-y-4">
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="col-span-1 md:col-span-1 lg:col-span-3">
            <SectorAllocationChart data={summary?.sectors || []} currency={currency} />
          </div>
        </div>
        ...
        <AddAssetDialog open={isAddOpen} onOpenChange={setIsAddOpen} onSubmit={addAsset} />
